...
Nello specifico abbiamo anche fissato le condizioni di lavoro ottimali del tubo radiogeno, limitando le frequenze a $ \nu < 2000 \unit{s^{-1}}$ per rimanere nella regione di risposta lineare del contatore.
