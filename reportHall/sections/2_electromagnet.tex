...
- & - & - & - & 500 & 30 & 2.98 & 0.05
\end{tabular}
\caption{Dati dei cicli di isteresi. Tutte le misure di corrente sono in $ \unit{A} $, e tutte quelle di campo magnetico in $ \unit{mT} $ (come anche riportato sui grafici in \cref{fig:hysteresis}).}
...
\caption{Curve di salita e discesa dei cicli di isteresi (con il campo magnetico $ B $ in $ \unit{mT} $ e la corrente nelle bobine $ I $ in $ \unit{A} $): in rosso i dati, e in blu le curve delle regressioni lineari (parametri del fit in legenda). Abbiamo limitato i range dei fit alle regioni di linearità delle curve.}
...
\begin{align}
B_\text{up,1}(I) &= (-8.7 \pm 1.2) \unit{mT} + \qty[(238 \pm 4) \unit{mT / A}] \cdot I \\
B_\text{down,1}(I) &= (9.2 \pm 1.3) \unit{mT} + \qty[(238 \pm 4) \unit{mT / A}] \cdot I \\
B_\text{up,2}(I) &= (-8.6 \pm 1.2) \unit{mT} + \qty[(239 \pm 4) \unit{mT / A}] \cdot I \\
B_\text{down,2}(I) &= (8.8 \pm 1.3) \unit{mT} + \qty[(238 \pm 4) \unit{mT / A}] \cdot I.
\end{align}
...
B_\text{up}(I) &= (-8.7 \pm 0.9) \unit{mT} + \qty[(239 \pm 3) \unit{mT / A}] \cdot I \\ \label{eq:hysteresis-down}
B_\text{down}(I) &= (9.0 \pm 0.9) \unit{mT} + \qty[(238 \pm 3) \unit{mT / A}] \cdot I \\ \label{eq:hysteresis-mean}
B_\text{mean}(I) &= (0 \pm 9) \unit{mT} + \qty[(238 \pm 2) \unit{mT / A}] \cdot I
\end{align}
