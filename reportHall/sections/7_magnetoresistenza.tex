...
\end{equation}
che non è compatibile con l'altra stima che ne abbiamo dato, e questo probabilmente è da attribuirsi al numero limitato di dati che abbiamo a disposizione per fare la regressione, e anche al fatto che stiamo usando dei modelli semplificati.
