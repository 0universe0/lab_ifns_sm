...
\end{tabular}
\caption{Dati sulla magnetoresistenza bla bla}
...
\end{tabular}
\caption{magnetoresistenza fit+dati parabola}
...
\caption{magnetoresistenza parabola}
...
\caption{fit delle caratteristiche}
...
\end{equation}
da cui allora per confronto con l'\cref{eq:magnetoresistance}:
\begin{equation}
\mu = (0.44 \pm 0.02) \unit{m^2 / V \cdot s}.
\end{equation}

\help{considerare la covarianza (magari), e mettere in evidenza che i dati nel fit sono stati convertiti in tesla (dai millitesla della tabella).}
