...
Misuriamo la tensione di Hall $ V_H $ con un elettrometro (Keithley) e la corrente $ i_p $ con un amperometro (Amprobe 37XRA) collegati alle connessioni sulla sonda mostrate in \cref{fig:hall-probe}, mentre controlliamo il campo magnetico attraverso la variazione di corrente di alimentazione delle bobine dell'elettromagnete (misurata con un amperometro identico, come in \cref{fig:hall-probe}).
