...
\hline
0.000000 & 0.000010 & -0.008 & 0.004 & 0.000000 & 0.000010 & -0.007 & 0.004 & 0.000000 & 0.000010\\
...
$m$ & $\delta m$ & $q$ & $\delta q$ & $m_\text{corr}$ & $\delta m_\text{corr}$ & $q_\text{corr}$ & $\delta q_\text{corr}$ \\
\hline
0.4683 & 0.0008 & -0.009 & 0.002 & 0.4141 & 0.0008 & -0.012 & 0.002\\
0.8659 & 0.0014 & -0.008 & 0.003 & 0.8117 & 0.0014 & -0.012 & 0.003\\
1.214 & 0.002 & -0.009 & 0.003 & 1.160 & 0.002 & -0.012 & 0.003\\
1.558 & 0.003 & -0.008 & 0.003 & 1.503 & 0.003 & -0.011 & 0.003\\
1.874 & 0.003 & -0.008 & 0.003 & 1.820 & 0.003 & -0.011 & 0.003\\
-0.2625 & 0.0005 & -0.0027 & 0.0015 & -0.3167 & 0.0005 & -0.0058 & 0.0018\\
-0.6694 & 0.0011 & -0.003 & 0.002 & -0.7235 & 0.0011 & -0.006 & 0.003\\
-1.0436 & 0.0017 & -0.001 & 0.003 & -1.0978 & 0.0017 & -0.004 & 0.003\\
-1.407 & 0.002 & 0.000 & 0.003 & -1.462 & 0.002 & -0.003 & 0.003\\
-1.715 & 0.003 & 0.000 & 0.003 & -1.769 & 0.003 & -0.003 & 0.003
\end{tabular}
\caption{Risultati dei fit nell'\cref{eq:VHip}. In particolare su questi valori corretti svogliamo la regressione per dare la stima di $ R_H $ (in \cref{fig:RH1}). I valori corretti sono stati ottenuti sottraendo i parametri del fit dell'\cref{eq:ohmic-contribution}.}
\label{tab:slope-VHi}
\end{table}

\help{add magnetic field to this table: we use it for the fit}

\help{$q$ are not compatible w/ $ 0 $: why?}
...
\caption{Regressione sui coefficienti angolari $ m_\text{corr} $ in tabella (\ref{tab:slope-VHi}) al variare del campo magnetico.}
\label{fig:RH1}
\end{figure}
