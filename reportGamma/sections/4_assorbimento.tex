...
\begin{figure}
  ...
  \caption{Regressione con il modello di Lambert-Beer (eq. \ref{eq:decay}) ai dati in \cref{tab:csassorbim}. Evidentemente il fit converge in maniera accettabile, e abbiamo anche trovato compatibilità tra il coefficiente di assorbimento $ \mu $ teorico e quello estratto da questa regressione. \help{forse mancano unità di misura sugli assi }}
	\label{fig:absorb}
\end{figure}
