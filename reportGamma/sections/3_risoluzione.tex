...
\help{manca spiegazione su come abbiamo calcolato $ \Delta E $ (per l'errore c'è la storia della covarianza, guarda come sono scritte le funzioni in python se non ricordi): ci vanno le formule che abbiamo usato (circa)}

% !!! li ho commentati solo perché non riuscivo a capire cosa c'è scritto, però magari tu riesci a interpretare !!!
%Abbiamo calcolato $ \Delta E $ utilizzando la funzione per il calcolo dell'energia per l'estremo superiore ed inferiore passando come valori: posizione del centroide $ \pm FWHM/2 $. Dalla loro differenza otteniamo il valore cercato.\\
%Per quanto riguarda l'errore sulla risoluzione abbiamo propagato gli errori noti sui canali risalendo all'errore su $ \Delta E $, $ E $. 

Tenendo conto del contributo derivante dalla quantità dei portatori di carica \help{??? non penso sia vero}, la forma finale dell'espressione teorica utilizzata per costruire il fit è la seguente:
...
\help{mancano i risultati del fit, la tabella con i dati del fit, e i nomi (con unità di misura) degli assi del grafico}
