...
dell'espressione teorica $ R = \frac{\Delta E}{E} $. Tenendo conto del contributo derivante dalla quantità dei portatori di carica, la forma finale dell'espressione teorica utilizzata per costruire il fit è la seguente:
\begin{equation}
    R = \frac{k}{\sqrt{E}} + c
\end{equation}
dove entrambi i parametri coinvolti: $ c $ (risoluzione intrinseca dello scintillatore) e $ k $ sono parametri liberi del fit.
Abbiamo determinato il valore sperimentale dell'energia a partire dai dati relativi ai due picchi delle sorgenti di \ce{^60Co} \ce{^137Cs} e \ce{^22Na}. Il seguente grafico caratterizza la risoluzione del rivelatore in funzione dell'energia nominale osservata:
\begin{center}
    \includegraphics[scale=0.5]{images/energeticResolution}
\end{center}
