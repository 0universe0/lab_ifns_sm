...
\begin{table}
	...
	\begin{tabular}{c|ccc|cc|cc}
		sorgente & $A_g$ & $A_n$ & $ \delta A_n $ & $t_\text{live} \, [\unit{s}]$ & $\delta t_\text{live} \, [\unit{s}]$ & $R \, [\unit{s^{-1}}]$ & $\delta R \, [\unit{s^{-1}}]$ \\
		\hline
		FS65 & 273300 & 257800 & 500 & 349.150 & 0.010 & 738.3 & 1.5 \\ 
		FS66 & 55541 & 51400 & 200  & 354.170 & 0.010  & 145.2 & 0.7 
	\end{tabular}
...
Usando l'equazione in \cref{eq:absactivity} con i rate in \cref{tab:csrates} abbiamo ricavato:
\begin{equation}
