...
\crefname{subsection}{sezione}{sezione}
...
\small{Corso di Introduzione alla Fisica Nucleare e Subnucleare con Laboratorio, A.A. 2025-26} \\
\vspace{0.4cm}
\small{\textbf{Relazione Tecnica di Laboratorio}}\\
\vspace{0.4cm}
\LARGE{\textbf{Esperienza: Raggi Gamma}}
\vspace{0.4cm} \\
...
\fancyhead[L]{\small IFNS}
\fancyhead[C]{\small \bfseries Raggi Gamma}
\fancyhead[R]{\small gruppo C1}

\input{./sections/1_intro.tex}

\input{./sections/2_spettri.tex}

\input{./sections/3_risoluzione.tex}

\input{./sections/4_assorbimento.tex}

\input{./sections/5_conclusioni.tex}
